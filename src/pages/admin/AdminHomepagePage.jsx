...
const DEFAULT_FIELDS = [
  ...
  { section: 'credibility', key: 'stat1_icon', label: 'Stat 1 Icon (Shield/Users/Calendar/Award)', type: 'text', value: 'Shield' },
  { section: 'credibility', key: 'stat1_value', label: 'Stat 1 Value', type: 'text', value: 'ISO 9001:2015' },
  { section: 'credibility', key: 'stat1_label', label: 'Stat 1 Label', type: 'text', value: 'Certified Quality Management' },
  { section: 'credibility', key: 'stat2_icon', label: 'Stat 2 Icon (Shield/Users/Calendar/Award)', type: 'text', value: 'Users' },
  { section: 'credibility', key: 'stat2_value', label: 'Stat 2 Value', type: 'text', value: '200+' },
  { section: 'credibility', key: 'stat2_label', label: 'Stat 2 Label', type: 'text', value: 'Happy Clients' },
  { section: 'credibility', key: 'stat3_icon', label: 'Stat 3 Icon (Shield/Users/Calendar/Award)', type: 'text', value: 'Calendar' },
  { section: 'credibility', key: 'stat3_value', label: 'Stat 3 Value', type: 'text', value: '30+' },
  { section: 'credibility', key: 'stat3_label', label: 'Stat 3 Label', type: 'text', value: 'Years of Excellence' },
  { section: 'credibility', key: 'stat4_icon', label: 'Stat 4 Icon (Shield/Users/Calendar/Award)', type: 'text', value: 'Award' },
  { section: 'credibility', key: 'stat4_value', label: 'Stat 4 Value', type: 'text', value: 'CII MSME' },
  { section: 'credibility', key: 'stat4_label', label: 'Stat 4 Label', type: 'text', value: 'Member & GeM Registered' },
  ...
  { section: 'about', key: 'stat1_icon', label: 'About Stat 1 Icon (Calendar/Users/Heart/Lightbulb)', type: 'text', value: 'Calendar' },
  { section: 'about', key: 'stat1_value', label: 'About Stat 1 Value', type: 'text', value: '33+' },
  { section: 'about', key: 'stat1_label', label: 'About Stat 1 Label', type: 'text', value: 'Years in Business' },
  { section: 'about', key: 'stat2_icon', label: 'About Stat 2 Icon (Calendar/Users/Heart/Lightbulb)', type: 'text', value: 'Users' },
  { section: 'about', key: 'stat2_value', label: 'About Stat 2 Value', type: 'text', value: '200+' },
  { section: 'about', key: 'stat2_label', label: 'About Stat 2 Label', type: 'text', value: 'Happy Clients' },
  { section: 'about', key: 'stat3_icon', label: 'About Stat 3 Icon (Calendar/Users/Heart/Lightbulb)', type: 'text', value: 'Heart' },
  { section: 'about', key: 'stat3_value', label: 'About Stat 3 Value', type: 'text', value: '30+' },
  { section: 'about', key: 'stat3_label', label: 'About Stat 3 Label', type: 'text', value: 'Team of Experts' },
  { section: 'about', key: 'stat4_icon', label: 'About Stat 4 Icon (Calendar/Users/Heart/Lightbulb)', type: 'text', value: 'Lightbulb' },
  { section: 'about', key: 'stat4_value', label: 'About Stat 4 Value', type: 'text', value: 'ISO 9001' },
  { section: 'about', key: 'stat4_label', label: 'About Stat 4 Label', type: 'text', value: 'Certified Quality' },
  { section: 'about', key: 'value1_text', label: 'Core Value 1', type: 'text', value: 'Agile to Customer Needs' },
  { section: 'about', key: 'value2_text', label: 'Core Value 2', type: 'text', value: 'Perfect Team Work' },
  { section: 'about', key: 'value3_text', label: 'Core Value 3', type: 'text', value: 'Focused Quality Improvements' },
  { section: 'about', key: 'value4_text', label: 'Core Value 4', type: 'text', value: 'Sustained Innovation & Engineering' },
